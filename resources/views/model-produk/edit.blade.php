...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="{{route('model-produk.edit', $data->id)}}">Ubah Model Gitar</a>
        </li>
    </ul>
</div>
<!-- END PAGE HEADER-->
...
<div class="portlet">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-reorder"></i> Ubah Sediaan Model Gitar
            </div>
        </div>
        <div class="portlet-body form">
            <form method="POST" action="{{ route('model-produk.update', $data->id) }}" enctype="multipart/form-data">
            @csrf
            @method("PUT")
            <div class="form-body">
