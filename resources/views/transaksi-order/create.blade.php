...
<div class="portlet">
		...
		<div class="portlet-body form">
			<form method="POST" action="{{ route('transaksi-order.store') }}" enctype="multipart/form-data">
			@csrf
				<div class="form-body">
                    <div class="form-group">
						...
						<select name="customer_id" id="customer_id" class="form-control @error('customer_id') is-invalid @enderror">
                            ...
                            @foreach($customer as $d)
                                <option value="{{ $d->id }}">{{ $d->nama_customer }}</option>
                            @endforeach
                        </select>
                        @error('customer_id')
                    ...
                    <div class="form-group">
						...
						<input type="text" class="form-control @error('no_po_customer') is-invalid @enderror" name="no_po_customer" value="{{ old('no_po_customer') }}" placeholder="Isikan nama bahan baku Anda" required>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input type="date" id="tanggal_order" name="tanggal_order" class="form-control @error('tanggal_order') is-invalid @enderror" placeholder="dd-mm-yyyy" value="{{ old('tanggal_order')}}">
                        </div>
                    </div>
                    <div class="form-group">
