...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="{{route('bill-of-material.create')}}">Tambah Sediaan Bill Of Material</a>
        </li>
    </ul>
</div>
<!-- END PAGE HEADER-->
...
<div class="portlet">
		<div class="portlet-title">
			<div class="caption">
				<i class="fa fa-reorder"></i> Tambah Sediaan Bill Of Material
			</div>
		</div>
		<div class="portlet-body form">
			<form method="POST" action="{{ route('bill-of-material.update', $data->id) }}" enctype="multipart/form-data">
                @method('PUT')
                @csrf
				<div class="form-body">
