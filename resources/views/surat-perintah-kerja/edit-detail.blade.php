...
<div class="portlet">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-reorder"></i> Edit Detail Surat Perintah Kerja
        </div>
    </div>
    <div class="portlet-body form">
        <form method="POST" action="{{ route('surat-perintah-kerja.update-detail', $data->id) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-body">
