...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="{{ route('surat-perintah-kerja.create') }}">Tambah Surat Perintah Kerja</a>
        </li>
    </ul>
</div>
@if(session('success'))
...
<div class="portlet">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-reorder"></i> Surat Perintah Kerja
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <p class="control-label">Tanggal Surat Perintah Kerja : {{ $order->tanggal_order }}</p>
...
<div class="portlet">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-reorder"></i> Tambah Detail Surat Perintah Kerja
        </div>
    </div>
    <div class="portlet-body form">
        <form method="POST" action="{{ route('surat-perintah-kerja.save-detail') }}" enctype="multipart/form-data">
            @csrf
            <div class="form-body">
...
<div class="portlet">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-reorder"></i> List Detail Surat Perintah Kerja
        </div>
    </div>
    <div class="portlet-body form">
            ...
            <tbody>
                ...
                <td>
                    <ul class="nav nav-pills">
                        <li >
                            <button onclick="window.location='{{ route('surat-perintah-kerja.edit-detail', $d->id) }}'" type="button" class="btn btn-success">Ubah</button>
                        </li>
                        {{-- <li>
